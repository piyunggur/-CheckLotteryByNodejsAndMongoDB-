            ...
            for (var k in result[j]) {
                ...
                if (k === 'firstPrize') {
                    if (full === result[j][k]['1']) {
                        a[full].push({
                            'ประเภทรางวัล': 'รางวัลที่ 1',
                            'หมายเลข': full,
                            'รางวัลละ': result[j][k]['prize']
                        });
                    }
                }
                if (k === 'front3') {
                ...
                if (k === 'nearby') {
                    for (var m in result[j][k]) {
                        if (full === result[j][k][m]) {
                            a[full].push({
                                'ประเภทรางวัล': 'รางวัลข้างเคียงรางวัลที่ 1',
                                'หมายเลข': full,
                                'รางวัลละ': result[j][k]['prize']
                            });
                        }
